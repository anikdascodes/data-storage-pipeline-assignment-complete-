...
- Reads competitor sales CSV files (clean + dirty)
...
def main(config_path: str):
    ...
    logger.info("Starting ETL pipeline for Competitor Sales")
    ...
    if 'source_path' in competitor_config:
        source_path = competitor_config['source_path']
        bronze_path = competitor_config['bronze_path']
        archive_path = competitor_config['archive_path']
    else:
        # Old format fallback: use input_path as bronze_path
        bronze_path = competitor_config['input_path']
